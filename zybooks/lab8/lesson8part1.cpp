// This program will utilize multiple functions in order to calculate the total distance traveled
// on Earth and the Moon given an amount of seconds. It will read in the seconds in one function,
// calculate the earth distance in a function, the moon distance in another, and have a dedicated
// output function.
#include <iostream>
#include <iomanip>
#include <cmath>
